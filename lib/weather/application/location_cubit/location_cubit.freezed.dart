...
class _$LocationStateTearOff {
  ...
  _Success success(Position position) {
    return _Success(
      position,
    );
  }
...
abstract class _Initial extends LocationState {
...
class _$_Success extends _Success {
  const _$_Success(this.position) : super._();
...
abstract class _Success extends LocationState {
  const factory _Success(Position position) = _$_Success;
...
/// @nodoc
class __$FailureCopyWithImpl<$Res> extends _$LocationStateCopyWithImpl<$Res>
...
abstract class _Failure extends LocationState {
